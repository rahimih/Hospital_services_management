...
{
    public partial class Physio_reporting20_F : Form
    {
        public string fromdate;
        public string todate;
        public int doctorscode, servicescode, emplyeetype, PaienttypeCodeName;
        public float zarib,zaribt;
        public string ipadress;

        public Physio_reporting20_F()
        {
            InitializeComponent();
        }
        ...
        private void Physio_reporting2_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Physio_report20.rpt");
