...
{
    public partial class Surgey_detail_Report_F : Form
    {
        public int turnid, SurgeryRecipeCode;
        public string ipadress;
        public Surgey_detail_Report_F()
        {
            InitializeComponent();
        }
        ...
        private void Surgey_detail_Report_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Surgey_detail_Report.rpt");
            ...
            crParameterDiscreteValue.Value = SurgeryRecipeCode;
            crParameterFieldDefinitions = cryRpt.DataDefinition.ParameterFields;
            crParameterFieldDefinition = crParameterFieldDefinitions["@SurgeryRecipeCode"];
            crParameterValues = crParameterFieldDefinition.CurrentValues;
            crParameterValues.Add(crParameterDiscreteValue);
            crParameterFieldDefinition.ApplyCurrentValues(crParameterValues);
