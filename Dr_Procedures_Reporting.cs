...
{
    public partial class Dr_Procedures_Reporting : Form
    {
        ...
        int reporintNo = 1;
        int year_s;
        public Dr_Procedures_Reporting()
        {
            InitializeComponent();
        }
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            ...
            if (reporintNo == 1)
            {
                DLUtilsobj.Dr_Procedures_Recipeobj.Dr_Procedures_Xml_5_view(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker3.Value.ToString("yyyy/MM/dd"), zaribf , zaribft ,5);
                ...
                DLUtilsobj.Dr_Procedures_Recipeobj.xml_5(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker3.Value.ToString("yyyy/MM/dd"), zaribf,zaribft,5);
                SqlDataReader DataSource;
                DLUtilsobj.Dr_Procedures_Recipeobj.Dbconnset(true);
                DataSource = DLUtilsobj.Dr_Procedures_Recipeobj.Dr_Procedures_Recipeclientdataset.ExecuteReader();


                /*XmlTextWriter XmlWrt = new XmlTextWriter("Dr_Procedures_xml_5" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml", System.Text.UTF8Encoding.UTF8);
                ...
                MessageBox.Show("فایل با نام " + "Dr_Procedures_xml_5" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                 */

                saveFileDialog1.FileName = "Dr_Procedures_xml_5_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml";
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("فایل با نام " + "Dr_Procedures_xml_5_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                }
                DataSource.Close();
                DLUtilsobj.Dr_Procedures_Recipeobj.Dbconnset(false);
            ...
            if (reporintNo == 5)
            {
                ...
                emr_report_joblocations_Frm.kinduse = 8;
            ...
            if (reporintNo == 6)
            {
                ...
                emr_report_services_Frm.kinduse = 8;
            ...
            if (reporintNo == 8)
            {
                DLUtilsobj.Dr_Procedures_Recipeobj.Dr_Procedures_Xml_5_view(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker3.Value.ToString("yyyy/MM/dd"), zaribf,zaribft,1);
                SqlDataReader DataSource1;
                DLUtilsobj.Dr_Procedures_Recipeobj.Dbconnset(true);
                DataSource1 = DLUtilsobj.Dr_Procedures_Recipeobj.Dr_Procedures_Recipeclientdataset.ExecuteReader();
                radGridView3.DataSource = DataSource1;
                ...
                DLUtilsobj.Dr_Procedures_Recipeobj.xml_5(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"), persianDateTimePicker3.Value.ToString("yyyy/MM/dd"), zaribf,zaribft,1);
                SqlDataReader DataSource;
                DLUtilsobj.Dr_Procedures_Recipeobj.Dbconnset(true);
                DataSource = DLUtilsobj.Dr_Procedures_Recipeobj.Dr_Procedures_Recipeclientdataset.ExecuteReader();


                /*XmlTextWriter XmlWrt = new XmlTextWriter("Dr_Procedures_xml_1" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml", System.Text.UTF8Encoding.UTF8);
                ...
                DataSource.Close();
                DLUtilsobj.Sono_recipeobj.Dbconnset(false);
                MessageBox.Show("فایل با نام " + "Dr_Procedures_xml_1" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                 */

                saveFileDialog1.FileName = "Dr_Procedures_xml_1_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml";
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    TextWriter tw = new StreamWriter(saveFileDialog1.FileName);
                    tw.WriteLine("<?xml version=" + @"""1.0""" + " standalone=" + @"""yes""" + "?>");
                    ...
                    MessageBox.Show("فایل با نام " + "Dr_Procedures_xml_1_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                }
                DataSource.Close();
                DLUtilsobj.Dr_Procedures_Recipeobj.Dbconnset(false);
            }
            ...
            if (reporintNo == 18)
            {
                dr_procedures_report_employee1_F dr_procedures_report_employee1_Frm = new dr_procedures_report_employee1_F();
                dr_procedures_report_employee1_Frm.fromdate = persianDateTimePicker2.Value.ToString("yyyy/MM/dd");
                dr_procedures_report_employee1_Frm.todate = persianDateTimePicker3.Value.ToString("yyyy/MM/dd");
                dr_procedures_report_employee1_Frm.ipadress = ipadress;
                dr_procedures_report_employee1_Frm.ShowDialog();
            }

            if (reporintNo == 19)
            {
                dr_procedures_report_employee2_F dr_procedures_report_employee2_Frm = new dr_procedures_report_employee2_F();
                dr_procedures_report_employee2_Frm.fromdate = persianDateTimePicker2.Value.ToString("yyyy/MM/dd");
                dr_procedures_report_employee2_Frm.todate = persianDateTimePicker3.Value.ToString("yyyy/MM/dd");
                dr_procedures_report_employee2_Frm.ipadress = ipadress;
                dr_procedures_report_employee2_Frm.ShowDialog();
            }
