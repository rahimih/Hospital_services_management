...
{
    public partial class dr_procedures_report_employee2_F : Form
    {
        public string fromdate;
        public string todate;
        public string ipadress;
        public dr_procedures_report_employee2_F()
        {
            InitializeComponent();
        }
        ...
        private void Comision_report1_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\dr_procedures_report_employee2.rpt");
