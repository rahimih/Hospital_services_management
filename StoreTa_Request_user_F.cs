...
{
    public partial class StoreTa_Request_user_F : Form
    {
        ...
        public StoreTa_Request_user_F()
        {
            InitializeComponent();
        }

         bool loaddata_right_Ta(string searchtext)
        {
        ...
        private void Ins_Button_Click_1(object sender, EventArgs e)
        {
            ...
            {
                if (kind == "Ta")
                    a = DLUtilsobj.StoreTaobj.InsertStoreta_Export(department_code, usercodexml, sdate, DateTime.Now.ToShortTimeString(), usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0);
                else if (kind == "Ph")
                    a = DLUtilsobj.StorePhobj.InsertStorePh_Export(department_code, usercodexml, sdate, DateTime.Now.ToShortTimeString(), usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0);
