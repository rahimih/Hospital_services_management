...
{
    public partial class Physio_reporting13_F : Form
    {
        ...
        private void Physio_reporting13_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\physio_report13.rpt");
