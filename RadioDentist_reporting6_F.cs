...
{
    public partial class RadioDentist_reporting6_F : Form
    {
        public string fromdate;
        public string todate;
        public string ipadress;
        public RadioDentist_reporting6_F()
        {
            InitializeComponent();
        }
        ...
        private void Radio_reporting6_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\RadioDentist_report6.rpt");
