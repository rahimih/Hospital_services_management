...
{
    public partial class StoreTa_Request_Detail_F : Form
    {
        ...
        public StoreTa_Request_Detail_F()
        {
            InitializeComponent();
        }
        ...
        private void Ins_Button_Click(object sender, EventArgs e)
        {
            ...
            /*   else if ((label5.Text<>"-") && ((int.Parse(label5.Text)) < (int.Parse(textBox2.Text))))
                ...
                {
                    if (kind == "Ta")
                        DLUtilsobj.StoreTaobj.InsertStoreTa_ExportDetail(export_code, kala_code, textBox2.Text, textBox2.Text, 0, usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0,textBox9.Text);
                    else if (kind == "Ph")
                        DLUtilsobj.StorePhobj.InsertStorePh_ExportDetail(export_code, kala_code, textBox2.Text, textBox2.Text, 0, usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0,textBox9.Text);
