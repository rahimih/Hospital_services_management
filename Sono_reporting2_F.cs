...
{
    public partial class Sono_reporting2_F : Form
    {
        public string fromdate;
        public string todate, doctorscode;
        public int  servicescode;
        public float zarib, zaribt;
        public string ipadress;
        public Sono_reporting2_F()
        {
            InitializeComponent();
        }
        ...
        private void Sono_reporting2_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Sono_report2.rpt");
        ...
        private void Sono_reporting2_F_Load()
        {
