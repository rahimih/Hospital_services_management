...
{
    public partial class Psychology_Services_F : Form
    {
        ...
        public string kinduse;
        public Psychology_Services_F()
        {
            InitializeComponent();
        }
        ...
        {
             DLUtilsobj.psychology_Recipeobj.psychology_Services_view2(kinduse);
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                radGridView1.Columns[2].HeaderText = "Attribute";                
                radGridView1.Columns[3].HeaderText = "جز حرفه ای";
                radGridView1.Columns[4].HeaderText = "جز فنی";
                radGridView1.Columns[5].HeaderText = "K";                
            }
            return false;
        }
        ...
        private void Ins_Button_Click(object sender, EventArgs e)
        {
            ...
            if (DLUtilsobj.psychology_Recipeobj.seach_psychology_Services(textBox5.Text,kinduse)==true)
            {
            ...
            {
                DLUtilsobj.psychology_Recipeobj.insert_psychology_Services(textBox5.Text, kinduse);
