...
{
    public partial class RadioDentist_reporting11_F : Form
    {
        public string fromdate;
        public string todate;
        public float zarib,zaribt;
        public int PaienttypeCodeName;
        public int Paienttype;
        public string ipadress;
        public RadioDentist_reporting11_F()
        {
            InitializeComponent();
        }
        ...
        private void Radio_reporting11_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\RadioDentist_report11.rpt");
