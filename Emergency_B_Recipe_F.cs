...
{
    public partial class Emergency_B_Recipe_F : Form
    {
        ...
        private bool cleardata()
        {
            ...
            Bedrid_cause_comboBox.SelectedIndex = 0;
        ...
        private void Radio_Recipe_F_Load(object sender, EventArgs e)
        {
            ...
            comboBox7.DisplayMember = "CL_cause_anme";
            comboBox7.ValueMember = "CL_cause_code";


            comboBox4.DisplayMember = "Room_Name";
            comboBox4.ValueMember = "Room_number";


            comboBox3.DisplayMember = "bedroom_Name";
            comboBox3.ValueMember = "bedroom_number";
            ...
            Services_F_combo.DataSource = DayclinicEntitiescontext.Emergeny_Services.Where(P => P.services_b == true).OrderBy(P => P.orders_b).ToList();
            ...
            comboBox7.DataSource = DayclinicEntitiescontext.EMR_CL_cause.Where(S => S.deleted==false).ToList();
            comboBox4.DataSource = DayclinicEntitiescontext.EMR_Room_number.ToList();
            room_no = byte.Parse(comboBox4.SelectedValue.ToString());
            comboBox3.DataSource = DayclinicEntitiescontext.EMR_bedroom_number.Where(R => R.Room_number == room_no).ToList();
           ...
           // Shift_comboBox.SelectedValue = shiftcode;
            ...
            //********************
            persianDateTimePicker1.Value = DLUtilsobj.StorePhobj.shamsitomiladi(persianDateTimePicker2.Value.ToString("yyyy/MM/dd"));

            //persianDateTimePicker1.Value = persianDateTimePicker2.Value;
            persianDateTimePicker4.Value = persianDateTimePicker1.Value;
            persianDateTimePicker5.Value = persianDateTimePicker1.Value;
            persianDateTimePicker4.ShowTime = true;
            persianDateTimePicker5.ShowTime = true;
        ...
        private void button3_Click(object sender, EventArgs e)
        {
           ...
           
                  {
                      ...
                      Turnid = DLUtilsobj.EMR_recipeobj.Insertrecipe(idperson, persno, Personelcode, fkvdfamily, persianDateTimePicker1.Value.ToString("yyyy/MM/dd"), DateTime.Now.ToShortTimeString(), 0, int.Parse(Doctors_comboBox.SelectedValue.ToString()), 1, byte.Parse(Shift_comboBox.SelectedValue.ToString()), byte.Parse(paienttype_comboBox.SelectedValue.ToString()), byte.Parse(paientstatus_comboBox.SelectedValue.ToString()), usercodexml, Environment.MachineName, int.Parse(Validcenterzone_combobox.SelectedValue.ToString()), int.Parse(comboBox5.SelectedValue.ToString()), byte.Parse(comboBox1.SelectedIndex.ToString()), byte.Parse(comboBox6.SelectedIndex.ToString()), byte.Parse(comboBox4.SelectedValue.ToString()), byte.Parse(comboBox3.SelectedValue.ToString()), int.Parse(Bedrid_cause_comboBox.SelectedIndex.ToString()), persianDateTimePicker4.Value.ToString("hh:mm"), persianDateTimePicker5.Value.ToString("hh:mm"), byte.Parse(comboBox7.SelectedValue.ToString()), 1,levels);
                       j = 0;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            Services_Select_Frm.kinduse = 72;
            ...
            if (Services_Select_Frm.insclick == true)
            {
                ...
                {                    
                    ...
                    {
                        if ((Services_Select_Frm.radGridView2.Rows[i1].Cells[1].Value.ToString())=="901948" || (Services_Select_Frm.radGridView2.Rows[i1].Cells[1].Value.ToString()=="901949"))
                        {
                            emr_teriazh = true;
                        }
