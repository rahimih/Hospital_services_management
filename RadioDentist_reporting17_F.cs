...
{
    public partial class RadioDentist_reporting17_F : Form
    {
        public string fromdate;
        public string todate;
        public float zarib,zaribt;
        public string ipadress;
        public RadioDentist_reporting17_F()
        {
            InitializeComponent();
        }
        ...
        private void Radio_reporting17_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\RadioDentist_report4.rpt");
