...
{
    public partial class StoreTa_Request_Second_F : Form
    {
        public DLibraryUtils.DLUtils DLUtilsobj;
        DayclinicEntities DayclinicEntitiescontext;
        public StoreTa_Request_Detail_Second_F StoreTa_Request_Detail_Second_Frm;
        ...
        public StoreTa_Request_Second_F()
        {
            InitializeComponent();
        }
        ...
        {
            DLUtilsobj.StoreTaobj.serach_StoreTa_request2_Full(export_code,searchtext);
        ...
        {
            DLUtilsobj.StorePhobj.serach_StorePh_request2_Full(export_code, searchtext);
        ...
        private void StoreTa_Request_F_Load(object sender, EventArgs e)
        {
            ...
            StoreTa_Request_Detail_Second_Frm = new StoreTa_Request_Detail_Second_F();
        ...
        private void Ins_Button_Click_1(object sender, EventArgs e)
        {
            ...
            if (kind == "Ta")
                a = DLUtilsobj.StoreTaobj.InsertStoreta_Export2("0", (usercodexml), sdate, DateTime.Now.ToShortTimeString(), usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0);            
            // (department_code,int.Parse(usercode),sdate,DateTime.Now.ToShortTimeString(),usercodexml,Environment.MachineName,sdate,DateTime.Now.ToShortTimeString(), 1, 0);
            else if (kind == "Ph")
                a = DLUtilsobj.StorePhobj.InsertStorePh_Export2("0", (usercodexml), sdate, DateTime.Now.ToShortTimeString(), usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0);            
           //(department_code, int.Parse(usercode), sdate, DateTime.Now.ToShortTimeString(), usercodexml, Environment.MachineName, sdate, DateTime.Now.ToShortTimeString(), 1, 0);
        ...
        private void radGridView1_DoubleClick(object sender, EventArgs e)
        {
            if (radGridView1.RowCount > 0)
            {
                StoreTa_Request_Detail_Second_Frm.label12.Text = radGridView1.CurrentRow.Cells[4].Value.ToString();
                StoreTa_Request_Detail_Second_Frm.kala_code = radGridView1.CurrentRow.Cells[0].Value.ToString();
                StoreTa_Request_Detail_Second_Frm.min_ues = int.Parse(radGridView1.CurrentRow.Cells[6].Value.ToString());
                StoreTa_Request_Detail_Second_Frm.max_use = int.Parse(radGridView1.CurrentRow.Cells[7].Value.ToString());
                StoreTa_Request_Detail_Second_Frm.export_code = a.ToString();
                StoreTa_Request_Detail_Second_Frm.usercodexml = usercodexml;
                StoreTa_Request_Detail_Second_Frm.sdate =sdate;
                StoreTa_Request_Detail_Second_Frm.kind = kind;
                StoreTa_Request_Detail_Second_Frm.kind2 = "I";
                
                StoreTa_Request_Detail_Second_Frm.ShowDialog();
                if (kind == "Ta")
