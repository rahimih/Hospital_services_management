...
{
    public partial class Sono_reporting7_F : Form
    {
        ...
        private void Sono_reporting3_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Sono_report7.rpt");
