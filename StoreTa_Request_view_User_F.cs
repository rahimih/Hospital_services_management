...
{
    public partial class StoreTa_Request_view_User_F : Form
    {
        ...
        public StoreTa_Request_view_User_F()
        {
            InitializeComponent();
        }

        private bool loaddata_right_Ta(string department_code)
        {
            DLUtilsobj.StoreTaobj.serach_StoreTa_export_department(department_code);
        ...
        private bool loaddata_right_Ph(string department_code)
        {
            DLUtilsobj.StorePhobj.serach_StorePh_export_department(department_code);
        ...
        private void Ins_Button_Click(object sender, EventArgs e)
        {
            if (radGridView1.RowCount > 0)
            {
                ...
                if (kind == "Ta")
                {
                    loaddata_right_Ta(department_code);
                }

                else if (kind == "Ph")
                {
                    loaddata_right_Ph(department_code);
                }
            }

        }

        private void StoreTa_Request_view_User_F_Load(object sender, EventArgs e)
        {
        ...
        private void StoreTa_Request_view_User_F_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                if (current_status == 1)
                {
                   ...
                   // StoreTa_Request_user_Frm.usercodexml = usercodetemp;
                    ...
                    StoreTa_Request_user_Frm.sdate = radGridView1.CurrentRow.Cells[2].Value.ToString();
                   ...
                   // StoreTa_Request_user_Frm.label12.Text = department_name;
                    ...
                    StoreTa_Request_user_Frm.label8.Text = radGridView1.CurrentRow.Cells[2].Value.ToString();
        ...
        private void toolStripMenuItem4_Click(object sender, EventArgs e)
        {
            if (button3.Enabled == true)
                button3_Click(toolStripMenuItem4, e);
        }
