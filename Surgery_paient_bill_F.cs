...
{
    public partial class Surgery_paient_bill_F : Form
    {
        public int turnid, SurgeryRecipeCode;
        public string ipadress;
        public Surgery_paient_bill_F()
        {
            InitializeComponent();
        }
        ...
        private void Surgery_paient_bill_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Surgery_paient_bill.rpt");
