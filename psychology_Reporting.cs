...
{
    public partial class psychology_Reporting : Form
    {
        ...
        private void Search_button_Click(object sender, EventArgs e)
        {
            ...
            if (reporintNo == 1)
            {
                ...
                saveFileDialog1.FileName = "psychology_" + kinduse.ToString() + "_xml_5_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml";
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                   ...
                   // DLUtilsobj.Physio_recipeobj.Dbconnset(false);
                    MessageBox.Show("فایل با نام " + "psychology_" + kinduse.ToString() + "_xml_5_" +  persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                }
                    DataSource.Close();
                    DLUtilsobj.psychology_Recipeobj.Dbconnset(false);
            ...
            if (reporintNo == 8)
            {
               ...
               */
                ...
                saveFileDialog1.FileName = "psychology_" + kinduse.ToString() + "_xml_1_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml";
                if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                {
                    TextWriter tw = new StreamWriter(saveFileDialog1.FileName);
                    tw.WriteLine("<?xml version=" + @"""1.0""" + " standalone=" + @"""yes""" + "?>");
                    ...
                    //DLUtilsobj.Physio_recipeobj.Dbconnset(false);
                    MessageBox.Show("فایل با نام " + "psychology_" + kinduse.ToString() + "_xml_1_" + persianDateTimePicker3.Value.Year.ToString() + persianDateTimePicker3.Value.Month.ToString() + ".xml" + " ایجاد گردید.", "Information", MessageBoxButtons.OK);
                }
                DataSource.Close();
                DLUtilsobj.psychology_Recipeobj.Dbconnset(false);
            ...
            if (reporintNo == 20)
            {
                ...
                psychology_Reporting20_Frm.zarib = zaribf;
                psychology_Reporting20_Frm.zaribt = zaribft;
                psychology_Reporting20_Frm.emplyeetype = 65;
                psychology_Reporting20_Frm.PaienttypeCodeName = 65;
                psychology_Reporting20_Frm.ipadress = ipadress;
                psychology_Reporting20_Frm.kinduse = kinduse;
                psychology_Reporting20_Frm.ShowDialog();
            }
