...
{
    public partial class Sono_reporting13_F : Form
    {
        ...
        private void Sono_reporting13_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\sono_report13.rpt");
