...
{
    public partial class emr_report_joblocations_F : Form
    {
        public string fromdate;
        public string todate;
        public byte kinduse;
        public string ipadress;
        public emr_report_joblocations_F()
        {
            InitializeComponent();
        }
        ...
        private void emr_report_joblocations_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\emr_report_joblocations.rpt");
