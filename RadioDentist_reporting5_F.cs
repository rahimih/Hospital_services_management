...
{
    public partial class RadioDentist_reporting5_F : Form
    {
        public string fromdate;
        public string todate;
        public string ipadress;
        public RadioDentist_reporting5_F()
        {
            InitializeComponent();
        }
        ...
        private void Radio_reporting5_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\RadioDentist_report5.rpt");
