...
{
    public partial class Radio_Defaultanswer_Ins_F : Form
    {
        ...
        public Radio_Defaultanswer_Ins_F()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            else if (DLUtilsobj.radio_recipeobj.search_Radio_Defaultanswer(name_textBox.Text) == true)
            {
            ...
            {
                //******************
                Radio_Defaultanswer Radio_Defaultanswertbl = new Radio_Defaultanswer
                {
                ...
                DayclinicEntitiescontext.Radio_Defaultanswer.Add(Radio_Defaultanswertbl);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if ((name_textBox.Text != name) && (DLUtilsobj.radio_recipeobj.search_Radio_Defaultanswer(name_textBox.Text) == true))
            {
                MessageBox.Show(" نام جواب تکراری می باشد", "Warning", MessageBoxButtons.OK);
            }
            ...
            else if (MessageBox.Show("آیا مطمئن به ذخیره تغییرات  می باشید؟", "Confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
               // DLUtilsobj.radio_recipeobj.update_Radio_Defaultanswer (name_textBox.Text,richTextBox1.Rtf, answer_Code);
                Radio_Defaultanswer Radio_Defaultanswertable = DayclinicEntitiescontext.Radio_Defaultanswer.First(i => i.answer_Code == answer_Code);
                Radio_Defaultanswertable.answer = richTextBox1.Rtf;
                Radio_Defaultanswertable.Name = name_textBox.Text;
                DayclinicEntitiescontext.SaveChanges();
                DLUtilsobj.EventsLogobj.insertEventsLog(usercodexml.ToString(), DateTime.Now.Date.ToShortDateString(), DateTime.Now.ToShortTimeString(), 13, Environment.MachineName, answer_Code);
                MessageBox.Show("اطلاعات مورد نظر ثبت گردید", "Information", MessageBoxButtons.OK);
                this.Close();
            }
        }
