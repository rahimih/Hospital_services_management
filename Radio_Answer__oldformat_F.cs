...
{
    public partial class Radio_Answer__oldformat_F : Form
    {
        public string Fkvdfamily;
        public string DoctorsServices_Code;
        public string ipadress;
        public Radio_Answer__oldformat_F()
        {
            InitializeComponent();
        }
        ...
        private void Radio_Answer_F_Load(object sender, EventArgs e)
        {
            ...
            cryRpt.Load(Application.StartupPath + @"\Radio_Answer_CR.rpt");
