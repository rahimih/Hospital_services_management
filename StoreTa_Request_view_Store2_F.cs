...
{
    public partial class StoreTa_Request_view_Store2_F : Form
    {
        ...
        public StoreTa_Request_view_Store2_F()
        {
            InitializeComponent();
        }

        private bool loaddata_right_Ta()
        {
            DLUtilsobj.StoreTaobj.serach_StoreTa_export_Request2_store();
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                radGridView1.Columns[1].HeaderText = "نام درخواست کننده";
                radGridView1.Columns[2].HeaderText = "تاریخ درخواست";
                radGridView1.Columns[3].HeaderText = "ساعت درخواست";
        ...
        private bool loaddata_right_Ph()
        {
            DLUtilsobj.StorePhobj.serach_StorePh_export_Request2_store();
        ...
        {
            DLUtilsobj.StoreTaobj.serach_StoreTa_export2_detail(export_code, searchtext);
        ...
        {
            DLUtilsobj.StorePhobj.serach_StorePh_export2_detail(export_code, searchtext);
        ...
        private void Ins_Button_Click(object sender, EventArgs e)
        {
            if (radGridView1.RowCount > 0)
            {
                current_status = int.Parse(radGridView1.CurrentRow.Cells[4].Value.ToString());
                ...
                else if (current_status == 1)
                {
                    ...
                    if (resault == DialogResult.Yes)
                    {
                        ...
                        if (kind == "Ta")
                        {
                            DLUtilsobj.StoreTaobj.changestatus_storeTa_request2(a);

                        }
                        else if (kind == "Ph")
                        {
                            DLUtilsobj.StorePhobj.changestatus_storePh_request2(a);
        ...
        private void StoreTa_Request_view_Store2_F_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radGridView1.RowCount > 0)
            {
                ...
                {
                    StoreTa_Request2_print StoreTa_Request2_printfrm = new StoreTa_Request2_print();
                    StoreTa_Request2_printfrm.kind = 0;
                    StoreTa_Request2_printfrm.Export_code = a;
                    StoreTa_Request2_printfrm.ipadress = ipadress;
                    StoreTa_Request2_printfrm.ShowDialog();
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                if (current_status == 1)
                {
                    ...
                    if (resault == DialogResult.Yes)
                    {
                        ...
                        if (kind == "Ta")
                        {
                            DLUtilsobj.StoreTaobj.deleteStoreTa_Export2_user(a);
                            DLUtilsobj.StoreTaobj.deleteStoreTa_Export_detail2_user(a);

                        }
                        else if (kind == "Ph")
                        {
                            DLUtilsobj.StorePhobj.deleteStorePh_Export2_user(a);
                            DLUtilsobj.StorePhobj.deleteStorePh_Export_detail2_user(a);
                        }
                    }
                }
        ...
        private void StoreTa_Request_view_Store2_F_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.Dispose();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (radGridView2.RowCount > 0)
            {
                ...
                if (current_status == 1)
                {
                    ...
                    if (kind == "Ta")
                    {
                        DLUtilsobj.StoreTaobj.deleteStoreTa_ExportDetail2(int.Parse(radGridView2.CurrentRow.Cells[0].Value.ToString()));
                        loaddata_left_Ta(a.ToString(), textBox2.Text);
                    }
                    else if (kind == "Ph")
                    {
                        DLUtilsobj.StorePhobj.deleteStorePh_ExportDetail2(int.Parse(radGridView2.CurrentRow.Cells[0].Value.ToString()));
            ...
            if (radGridView1.RowCount > 0)
            {
                ...
                if (current_status == 1)
                {
                   ...
                   // StoreTa_Request_Second_Frm.usercodexml = usercodetemp;
                    ...
                    StoreTa_Request_Second_Frm.sdate = radGridView1.CurrentRow.Cells[3].Value.ToString();
                    StoreTa_Request_Second_Frm.kind = "Ta";
                    StoreTa_Request_Second_Frm.kind2 = "E";
                   // StoreTa_Request_Second_Frm.label12.Text = department_name;
                    StoreTa_Request_Second_Frm.label7.Text = radGridView1.CurrentRow.Cells[1].Value.ToString();
                    StoreTa_Request_Second_Frm.label8.Text = radGridView1.CurrentRow.Cells[3].Value.ToString();
                    StoreTa_Request_Second_Frm.label9.Text = radGridView1.CurrentRow.Cells[0].Value.ToString();
                    StoreTa_Request_Second_Frm.a=(Int64.Parse(radGridView1.CurrentRow.Cells[0].Value.ToString())); 
                    StoreTa_Request_Second_Frm.Ins_Button.Enabled = false;
                    StoreTa_Request_Second_Frm.panel3.Enabled = true;
                    StoreTa_Request_Second_Frm.panel4.Enabled = true;
                    StoreTa_Request_Second_Frm.button2.Enabled = true;
                    StoreTa_Request_Second_Frm.Del_Button.Enabled = true;
